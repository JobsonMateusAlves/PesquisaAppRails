...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "Cidades", primary_key: "codigo_cidade", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "nome_cidade", limit: 50
  end

  create_table "EstadoCivils", primary_key: "codigo_estado_civil", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "descricao_estado_civil", limit: 20
  end

  create_table "FaixaEtarias", primary_key: "codigo_faixa_etaria", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "descricao_faixa_etaria", limit: 20
  end

  create_table "Fontes", primary_key: "codigo_fonte", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "descricao_fonte", limit: 50
  end

  create_table "Instrucaos", primary_key: "codigo_instrucao", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "descricao_instrucao", limit: 50
  end

  create_table "Municipios", primary_key: "codigo_municipio", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "nome_municipio", limit: 50
  end

  create_table "PosicaoTrabalhos", primary_key: "codigo_posicao_trabalho", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "descricao_posicao_trabalho", limit: 40
  end

  create_table "Profissaos", primary_key: "codigo_profissao", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "descricao_profissao", limit: 80
  end

  create_table "Rendas", primary_key: "codigo_renda", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "descricao_renda", limit: 40
  end

  create_table "UFs", primary_key: "codigo_UF", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "nome_UF", limit: 2
  end

  create_table "pessoas", primary_key: "numero_registro", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
